...
public class BiddingWinnerService {
	...
	public void save(final BiddingWinner winner) {
		try {
			...
			System.out.println("Bidding: " + winner.getPk().getBidding().getBidId() + " docNumber: " + winner.getPk().getEntity().getDocumentNumber() + " nrItem : " + winner.getPk().getItemNumber());
			e.printStackTrace();
			throw e;
		}
	}

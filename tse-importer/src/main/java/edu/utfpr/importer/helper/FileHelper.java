...
public class FileHelper {
    ...
    private static final String CHUNK_DIRECTORY = "/temp/";
     ...
     * @param chunkSize
     */
    public static List<String> splitFile(final String absPath, final String fileName, final int chunkSize) {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(file), StandardCharsets.ISO_8859_1))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (content.length() > chunkSize) {
                    ...
                    createFile(absPath, name, content.toString());
                    chunkFiles.add(name);
            ...
            createFile(absPath, fileNumber + "-" + fileName, content.toString());
    ...
    public static void createFile(final String absPath, final String fileName, final String content) {
        File chunk = new File(absPath + CHUNK_DIRECTORY + fileName);
        try {
